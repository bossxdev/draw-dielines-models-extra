...
const MainLays = (options) => {
  ...
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_x))
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_x2))
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_x3))
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_x4))
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_xr))
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_xr2))
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_xr3))
  shapePlane.holes.push(new THREE.Path().setFromPoints(points_xr4))
