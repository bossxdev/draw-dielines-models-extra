...
const MainLays = (options) => {
  ...
  //! - - - Group All - - - *//
  const PlaneGroupClone = new THREE.Object3D() //* clone group
  PlaneGroupClone.position.set(length + width, 0, 0)
  PlaneGroupClone.add(Group_A_Top.clone(), Group_B_Top.clone(), Group_B_Top2.clone(), Group_E.clone())

  const PlaneGroup = new THREE.Object3D() //* group all
  PlaneGroup.add(Group_A_Top, Group_B_Top, Group_B_Top2, Group_E, Group_G, PlaneGroupClone, Group_RedLine )
...
const MainLays_Half = (options) => {
  ...
  //! - - - Group All - - - *//
  const PlaneGroup = new THREE.Object3D()
  PlaneGroup.add(Group_A_Top, Group_B_Top, Group_B_Top2, Group_E, Group_G, Group_RedLine)
