...
// Draw Ribbon
  ...
  PlaneGroup.add(Group_A_Top, Group_B_Top, Group_B_Top2, Group_D, Group_E, Group_G, PlaneGroupClone, Group_RedLine, ribbonGroupsLeft, ribbonGroupsRight, )
...
const MainLays_Half = (options) => {
  ...
  const PlaneGroup = new THREE.Object3D()
  PlaneGroup.add(Group_A_Top, Group_B_Top, Group_B_Top2, Group_D, Group_E, Group_G, Group_RedLine, ribbonGroupsLeft )
